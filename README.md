# Catalytic entanglement concentration (EC)
In this code we extend catalytic EC from pure states to mixed states. We compare it to non-catalytic EC and distillation in presence of state preparation errors. We also find out the effects of errors on the reusability of catalysts.  
We also find the effects of operational errors on the catalytic EC protocols.
